...
<script type="text/javascript">
			...
			$.ajax({
				...
				success:function (data) {
					...
					if (data.success){
                        ...
                        html+='<h5 id="n'+data.cr.id+'">'+data.cr.noteContent+'</h5>';
			...
			$.ajax({
				...
				success:function (data) {
					if (data.success){
					    ...
					    $("#s"+id).html(data.cr.editTime+' 由'+data.cr.editTime);
					    //关闭模态窗口
                ...
                $.ajax({
                    ...
                    success:function (data) {
                        if (data){
                            //刷新市场活动列表
                            showClueRemarkRelation()
                            //清除搜索文本框内容，复选框，清空activitySearchBody中的内容
                            $("#aname").val("")
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data,function (m,n) {
                    ...
                    html+='<font color="gray">线索</font> <font color="gray">-</font> <b>${c.fullname}${c.appellation}-${c.company}</b> <small style="color: gray;" id="s'+n.id+'"> '+(n.editFlag==0?n.createTime:n.editTime)+' 由'+(n.editFlag==0?n.createBy:n.editTime)+'</small>';
                    html+='<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
    ...
    //展示关联部分内容
	function showClueRemarkRelation() {
		$.ajax({
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" class="form-control" id="aname" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询" id="search-activity">
